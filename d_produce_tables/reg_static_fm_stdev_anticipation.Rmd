...
data = readRDS('../tmp/price_impact/regression_contemp/fm_stdev_anticipation.RDS')
...
data = merge(data, tmp, by = c('type_idx','lookback_window'))[, type_idx := NULL]; rm(tmp)
...
this_add_to_row <- list(pos = list(-1, 6, 8, 12, 18), 

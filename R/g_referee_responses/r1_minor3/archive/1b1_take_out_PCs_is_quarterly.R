# --- For each quarter, we can use daily returns to estimate PCA, and then take out the top PCs and get the residual quarterly returns?
library(this.path)
...
# save
to_file <- "tmp/pca_residuals/quarterly.RDS"

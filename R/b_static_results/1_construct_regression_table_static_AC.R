...
bmi_bandwidth = 5000 #300 #150

# All demand and returns
data <- readRDS(paste0("../tmp/raw_data/reg_inputs/all_ofi_and_ret_bw_", bmi_bandwidth, ".RDS"))
...
saveRDS(data, paste0(to_dir, "reg_table_static_bw_", bmi_bandwidth ,".RDS"))

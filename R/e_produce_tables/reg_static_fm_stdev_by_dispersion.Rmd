...
data <- readRDS("../g_referee_responses/r5_major2/tmp/reg_by_dispersion/fm_coefs_nbins_3.RDS")
...
data[, type_idx := ifelse(disp_type == "ofi_sd", 1, 2)]
data[, spec_idx := bin_disp]
...
print(x.side,
  ...
  sanitize.text.function = force, # Important to treat content of first column as latex function
  add.to.row = this_add_to_row,
  file = paste0(to_dir, "reg_static_fm_stdev_by_dispersion.tex")
)
```
...
\input{reg_asym_stdev_posneg_rebuilt_v4.tex}
\endgroup
\end{adjustbox}
\end{table}
...
\begin{table}[H]
\centering
\caption{v4 tests of equal positive and negative pairwise differences, static}
\label{tab:v4_delta_posneg_static}
\begin{adjustbox}{max width=\textwidth}
\input{test_v4_delta_posneg_static_spec3.tex}
\end{adjustbox}
\end{table}
...
\begin{adjustbox}{max width=\textwidth}
\input{summary_dynamic_asym_stdev_posneg_rebuilt_v4_4lag.tex}
\end{adjustbox}
\end{table}
...
\begingroup
\renewcommand{\vspace}[1]{}
\input{reg_dynamic_asym_stdev_posneg_rebuilt_v4_4lag.tex}
\endgroup
\end{adjustbox}
\end{table}
...
\begin{table}[H]
\centering
\caption{v4 tests of equal positive and negative pairwise differences, dynamic}
\label{tab:v4_delta_posneg_dynamic}
\begin{adjustbox}{max width=\textwidth}
\input{test_v4_delta_posneg_dynamic_spec3.tex}
\end{adjustbox}
\end{table}

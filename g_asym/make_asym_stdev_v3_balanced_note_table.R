# Generate the balanced-month LaTeX tabular used by asym_stdev_v3_note.tex.
#
# The table is generated from the balanced v3 pooled six-variable output:
#   fm_stdev_posneg_v3_balanced.RDS

library(data.table)
library(scales)

out <- readRDS("fm_stdev_posneg_v3_balanced.RDS")
...
writeLines(lines, "reg_asym_stdev_posneg_v3_balanced.tex")

...
lines <- c(
  ...
  "  \\hline \\multicolumn{7}{c}{Panel A: Regression coefficients} \\\\",
  " \\hline",
  "                                    & \\multicolumn{6}{c}{Dependent variable: stock return $r_{n,t}$} \\\\",
  "",
  "                                    \\cmidrule(l){2-7} & \\multicolumn{3}{c}{FIT} & \\multicolumn{3}{c}{OFI} \\\\",
  " \\cmidrule(l){2-4} \\cmidrule(l){5-7} ",
  "  & (1) & (2) & (3) & (4) & (5) & (6) \\\\ ",
  main_lines,
  row_line("Predictor controls", c("N", "Y", "Y", "N", "Y", "Y")),
  row_line("\\vspace{5pt}Liquidity controls", c("N", "N", "Y", "N", "N", "Y")),
